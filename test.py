...
text = '''
<p>To the Glorious (<term ref="1869">Śrī</term>) Gorakhanāthajī – 2 <note place="end">In
                  Naraharinātha's edition, the document starts with the invocation
                     "<foreign>śrīdurgāsahāyaḥ 1</foreign>" (<bibl corresp="883">Naraharinātha VS
                     2013</bibl>: 287). According to a copy kept in the documents of the Yogīcakra
                  Guṭhī, the invocation is simply "<foreign>śrī</foreign>" (K_0132_0008). Other
